...
/>
  ...
  <header className="flex justify-between items-center p-6 lg:pr-36">
    <h1 className="self-stretch my-auto text-5xl text-white max-md:text-4xl max-sm:text-3xl">
      <span className="font-extrabold text-blue-400">Fin</span>
      <span className="font-extrabold text-orange-400">Trac</span>
    </h1>
    <div className="space-x-4">
    <Link to="/login">
      <button className="overflow-hidden self-stretch px-4 py-2 lg:px-9 lg:py-4 my-auto rounded-full border border-blue-400 bg-blue-400 hover:bg-blue-500">
        Login
      </button>
      </Link>
      <Link to="/signup">
      <button className="overflow-hidden self-stretch px-4 py-2 lg:px-9 lg:py-4 my-auto rounded-full border border-orange-400 text-orange-100 hover:bg-orange-400 hover:text-white">
        Sign Up
      </button>
      </Link>
    </div>
  ...
  {/* Main Content */}
  <section className="flex flex-col-reverse lg:flex-row justify-between items-center lg:pl-3 px-6 lg:px-12 py-6 ipad:flex-col">
    <div className="flex flex-col-reverse lg:flex-row items-center justify-between w-full lg:max-w-full">
    <div className="flex overflow-hidden flex-col w-[500px] max-md:max-w-full ipad:w-[400px]">
  ...
  className="w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl lg:w-[45%] mt-6 lg:mt-0 aspect-w-16 aspect-h-9 ipad:max-w-[60%] animate-float"
/>
    </div>
  </section>
</div>
